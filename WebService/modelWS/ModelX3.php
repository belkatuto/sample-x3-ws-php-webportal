...
class ModelX3 {
	...
	public function run($publicName, $inputXml) {
		return $this->soapClient->__soapCall ( 'run', array (
				$this->callContext,
				$publicName,
				$inputXml 
		), array (
	...
	public function save($publicName, $objectXml) {
		return $this->soapClient->__soapCall ( 'save', array (
				$this->callContext,
				$publicName,
				$objectXml 
		), array (
	...
	public function delete($publicName, $objectKeys) {
		return $this->soapClient->__soapCall ( 'delete', array (
				$this->callContext,
				$publicName,
				$objectKeys 
		), array (
	...
	public function read($publicName, $objectKeys) {
		return $this->soapClient->__soapCall ( 'read', array (
				$this->callContext,
				$publicName,
				$objectKeys 
		), array (
	...
	public function query($publicName, $objectKeys, $listSize) {
		return $this->soapClient->__soapCall ( 'query', array (
				$this->callContext,
				$publicName,
				$objectKeys,
				$listSize 
	...
	public function getDescription($publicName) {
		return $this->soapClient->__soapCall ( 'getDescription', array (
				$this->callContext,
				$publicName 
		), array (
				'uri' => 'http://www.adonix.com/WSS',
	...
	public function modify($publicName, $objectKeys, $objectXml) {
		return $this->soapClient->__soapCall ( 'modify', array (
				$this->callContext,
				$publicName,
				$objectKeys,
				$objectXml 
	...
	public function actionObject($callContext, $publicName, $actionCode, $objectKeys) {
		return $this->soapClient->__soapCall ( 'actionObject', array (
				$callContext,
				$publicName,
				$actionCode,
				$objectKeys 
	...
	public function deleteLines($callContext, $publicName, $objectKeys, $blocKey, $lineKeys) {
		return $this->soapClient->__soapCall ( 'deleteLines', array (
				$callContext,
				$publicName,
				$objectKeys,
				$blocKey,
	...
	public function insertLines($callContext, $publicName, $objectKeys, $blocKey, $lineKey, $lineXml) {
		return $this->soapClient->__soapCall ( 'insertLines', array (
				$callContext,
				$publicName,
				$objectKeys,
				$blocKey,
	...
	public function getDataXmlSchema($callContext, $publicName) {
		return $this->soapClient->__soapCall ( 'getDataXmlSchema', array (
				$callContext,
				$publicName 
		), array (
				'uri' => 'http://www.adonix.com/WSS',
